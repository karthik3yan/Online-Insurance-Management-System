...
<body>
	...
	header("Location: /insurance/login.html");                }
            ...
            <div class="dashboard-ecommerce">
             ...
             <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">Claim A Policy</h5>
                                <div class="card-body">
		...
		$select = mysqli_query($con, "SELECT * from policies where user_email = '".$email."' AND status = 'Active' ORDER BY id DESC");
		if (mysqli_num_rows($select) != 0) {
			...
			while ($row = mysqli_fetch_assoc($select)) {       ?>                  
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['num_claims']; ?>&nbsp; Time</td>
                                                <td> <span class="badge badge-success"><?php echo $row['status']; ?></span></td>
                                                 <td><?php echo "<a href= 'claimmypolicy.php?pid=".$row['id']."'>Claim <i class = 'fas fa-arrow-alt-circle-right'></i></a>"; ?></td>
                                            </tr>
