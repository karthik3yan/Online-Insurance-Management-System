...
<body>
	...
	header("Location: /insurance/login.html");                }
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">New Policy</h5>
                                <div class="card-body">
		...
		$select = mysqli_query($con, "SELECT * from plans");
		if (mysqli_num_rows($select) != 0) {
			...
			while ($row = mysqli_fetch_assoc($select)) {       ?>                  
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['premium_amt_annual']; ?></td>
                                                <td><?php echo $row['term_range']; ?></td>
                                                <td><?php echo $row['insurer']; ?></td>
                                                <td><?php echo $row['age_range']; ?></td>
                                                 <td><?php echo "<a href= '/insurance/plandetails.php?pid=".$row['plan_id']."'>View / Apply <i class = 'fas fa-arrow-alt-circle-right'></i></a>"; ?></td>
                                            </tr>
             ...
             <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">My Policies</h5>
                                <div class="card-body">
		...
		$select = mysqli_query($con, "SELECT * from policies where user_email = '".$email."'  ORDER BY id DESC");
		if (mysqli_num_rows($select) != 0) {
			...
			while ($row = mysqli_fetch_assoc($select)) {       ?>                  
                                    ...
                                    <?php }
                                            ...
                                            {
                                                echo "No policies . <a href= 'newpolicy.php'><h5>Get a New Policy <i class = 'fas fa-arrow-alt-circle-right'></i></h5></a>";
