...
$pid = $_GET['pid'];
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="newpolicy.php">New Policy</a>
                                        </li>
             ...
             <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action= "policy_req.php?pid=<?php echo $pid; ?>" id="basicform" method="post" enctype="multipart/form-data" data-parsley-validate="">
                                        <div class="form-group">
                                            <label for="inputUserName"> Name</label>
                                            <input id="inputUserName" type="text" name="name" data-parsley-trigger="change" required="" placeholder="Enter Holder name" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputGender"> Gender</label>
                                            <input id="inputGender" type="text" name="gender" data-parsley-trigger="change" required="" placeholder="Enter Holder Gender(M/F)" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputdob"> Date Of Birth</label>
                                            <input id="inputdob" type="date" name="dob" data-parsley-trigger="change" required="" placeholder="Enter Holder DOB" max="2019-03-17" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputdob"> Term Range ( within  <?php   
                         if (isset($_GET['pid'])) {
                             
                             
                                                	
	
	$result = mysqli_query($con, "SELECT * FROM `plans` WHERE `plan_id` = '".$pid."' ");
	
	if (mysqli_num_rows($result) != 0) {

        while ($row = mysqli_fetch_assoc($result)) {
            		$range = $row['term_range'];
            echo $range;
	...
	header("Location: /insurance/login.html");                }
                       ...
                       ?> )</label>
                                            <input id="inputdob" type="text" name="range" data-parsley-trigger="change" required="" placeholder="Enter Term Range"  autocomplete="off" class="form-control">
                                        </div>
                                          <div class="form-group">
                                            <label for="inputdoc"> Upload Medical History / Documents </label>
	...
	if (mysqli_num_rows($result) != 0) {
       ...
       ?>
                            ...
                            <div class="card-header bg-info text-center p-3">
                                <h4 class="mb-0 text-white"> <?php echo $row['name']; ?></h4>
                            </div>
                            <div class="card-body text-center">
                                <h1 class="mb-1"><?php echo $row['sum_amt']; ?></h1>
                                <p>Sum Amount</p>
                            </div>
