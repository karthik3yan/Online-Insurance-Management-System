                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <a href="account.php"> <li class="breadcrumb-item">Account  &nbsp;-> &nbsp;</li>  </a>
                                             <a href="#"> <li class="breadcrumb-item"> Update </li> </a>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                ...
                if ($_GET['action'] == 'pswrd') { ?>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action= "update_req.php" id="basicform" method="post" data-parsley-validate="">
                                        <div class="form-group">
                                            <label for="inputp"> New Password</label>
                                            <input id="inputp" type="password" name="password" data-parsley-trigger="change" required="" placeholder="Enter New Password" autocomplete="off" class="form-control">
                                        </div>
                 ...
                 ?>
                  ...
                  if ($_GET['action'] == 'phone') { ?>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Change Your Phone Number</h5>
                                <div class="card-body">
                                    <form action= "update_req.php" id="basicform" method="post"  data-parsley-validate="">
                                        <div class="form-group">
                                            <label for="inputp"> New Phone Number</label>
                                            <input id="inputp" type="number" name="phone" data-parsley-trigger="change" required="" placeholder="Enter New Phone Number" autocomplete="off" class="form-control">
                                        </div>
