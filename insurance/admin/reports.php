             ...
             <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                               ...
                               <a href="policyreport.php" class='badge badge-primary'><h5 class="card-header">Generate Policy Reports&nbsp;&nbsp;&nbsp;&nbsp;<i class = 'fas fa-arrow-alt-circle-right'></i></h5></a><br><br><br>
                               <a href="claimreport.php" class='badge badge-primary'><h5 class="card-header">Generate Claim Reports&nbsp;&nbsp;&nbsp;&nbsp;<i class = 'fas fa-arrow-alt-circle-right'></i></h5></a>
