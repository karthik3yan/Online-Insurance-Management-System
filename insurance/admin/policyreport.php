...
<body>
            ...
            <div class="dashboard-ecommerce">
             ...
             <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">Generate Policies Issued within The Particular Dates</h5>
                                <div class="card-body">
                                    
                                    
                                    
                                    <form action= "policyreport.php" id="basicform" method="get" enctype="multipart/form-data" data-parsley-validate="">
   ...
   $to = $_GET['end'];
                    ...
                    $select = mysqli_query($con, "SELECT * from policies where `start_date` >+ '$from' and `start_date` <= '$to'");
		...
		$select = mysqli_query($con, "SELECT * from policies");
		if (mysqli_num_rows($select) != 0) {
